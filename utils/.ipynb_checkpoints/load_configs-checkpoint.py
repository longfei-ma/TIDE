...
def get_link_prediction_args(is_evaluation: bool = False):
    ...
    parser.add_argument('--dataset_name', type=str, help='dataset to be used', default='FOOD',
                        choices=['FOOD', 'IMDB', 'Librarything', 'Beeradvocate', 'Amazon-Kindle'])
    parser.add_argument('--llm_name', type=str, help='large language model to be used', default='BERT',
                        choices=["ST", "BERT", "e5", "llama3.1_8b"])
    ...
    parser.add_argument('--neighbors_cache', action='store_true', default=False, help='whether to cache collected neighbors to save memory')
    parser.add_argument('--messages_cache', action='store_true', default=False, help='whether to cache collected messages to save memory')
